  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloindicator', {
      ...
      buildIndicator: function() {
        ...
        editButton = jQuery('<div><i class="dz-icon-edit"></i> Edit</div>');
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonize = function(alignment) {
          ...
          buttonElement.hallobutton({
            ...
            icon: "dz-icon-align-" + (alignment.toLowerCase()),
            cssClass: _this.options.buttonCssClass
          });
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonize = function(type, label) {
          ...
          buttonElement.hallobutton({
            ...
            icon: "dz-icon-list-" + (label.toLowerCase()),
            cssClass: _this.options.buttonCssClass
          });
          return buttonset.append(buttonElement);
        };
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonize = function(cmd, label) {
          ...
          buttonElement.hallobutton({
            ...
            editable: _this.options.editable,
            label: label,
            icon: cmd === 'undo' ? 'dz-icon-undo' : 'dz-icon-repeat',
            command: cmd,
            queryState: false,
            cssClass: _this.options.buttonCssClass
          });
    ...
    jQuery.widget('IKS.hallobutton', {
      ...
      _create: function() {
        ...
        if ((_ref = (_base = this.options).icon) == null) {
          _base.icon = "dz-icon-" + (this.options.label.toLowerCase());
        }
  ...
  (function(jQuery) {
    return jQuery.widget('IKS.hallodropdownbutton', {
      ...
      _create: function() {
        ...
        return (_ref = (_base = this.options).icon) != null ? _ref : _base.icon = "dz-icon-" + (this.options.label.toLowerCase());
      },
      _init: function() {
        var target,
          _this = this;
