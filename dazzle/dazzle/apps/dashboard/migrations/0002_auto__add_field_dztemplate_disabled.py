...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DZTemplate.disabled'
        db.add_column(u'dashboard_dztemplate', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DZTemplate.disabled'
        db.delete_column(u'dashboard_dztemplate', 'disabled')
